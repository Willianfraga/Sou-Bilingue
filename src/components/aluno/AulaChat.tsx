...
// Só renderiza — recebe o contexto (nome do tutor, idioma) já resolvido pelo
// Server Component em page.tsx. A rota /api/aula/chat é quem decide de
// verdade o contexto no servidor, não este componente.
  ...
  return (
    <div className="flex h-[calc(100vh-5rem)] max-w-2xl flex-col gap-4">
      <div>
        ...
        <h1 className="mt-1 text-2xl font-bold">{tituloTutor}</h1>
      </div>
